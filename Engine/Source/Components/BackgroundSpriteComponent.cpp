...
BackgroundSpriteComponent::BackgroundSpriteComponent(Entity* owner, Renderer2D* renderer, const std::string& filename, int drawOrder) :
...
void BackgroundSpriteComponent::Draw(Renderer2D* renderer, Entity2D* owner)
{
	if (mTexture)
	{
		SDL_Rect r{};
